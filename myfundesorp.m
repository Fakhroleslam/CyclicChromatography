...
function dudt=myfundesorp(t,yin)
global nx epsilon kA  vdes  Daxdes delz kpades A DesorpQ cA0
dudt=zeros(2*nx,1);
dudt=dudt';
for i= 2:nx-1
    if i==2
    ...
    dudt(i)=(Daxdes*d2cA_dz2(i))-(-vdes)/epsilon*dcA_dz(i)-((1-epsilon)/epsilon)*dudt(i+nx+1);
end
end